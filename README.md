# Retrouvailles provenderie SARL - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Retrouvailles provenderie SARL**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@retrouvaillesprovenderiesarl.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@retrouvaillesprovenderiesarl.cm` | `user123` | |
...
*   **Contact :** contact@retrouvaillesprovenderiesarl.cm